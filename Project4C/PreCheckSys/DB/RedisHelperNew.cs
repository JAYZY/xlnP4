...
namespace PreCheckSys.DB {
    ...
    public class RedisHelperNew {
        ...
        public static double GetUsedMem() {
            double usedMEM = 0;
            var servInfo = _connMultiplexer.GetServer("127.0.0.1:6379").Info();
        ...
        public RedisHelperNew(int db = -1) {
        ...
        public T StringGet<T>(string redisKey) {
            redisKey = AddKeyPrefix(redisKey);
            return JsonHelper1.GetModel<T>(_db.StringGet(redisKey));
        }
